...
{{- if $envAll.Values.pod.tolerations.jobs.db_init.enabled | default false }}
{{- tuple $envAll "db_init" | include "helm-toolkit.snippets.kubernetes_job_tolerations" | indent 6 }}
{{- end }}
      initContainers:
